...
lyr_ESRIGraydark_0.setVisible(true);lyr_Ikkebygget_1.setVisible(true);lyr_Bygget_2.setVisible(true);
var layersList = [lyr_ESRIGraydark_0,lyr_Ikkebygget_1,lyr_Bygget_2];
